...
balUtilHTML = {
  ...
  replaceElement: function() {
    var args, element, html, ref, regex, removeIndentation, replace, result;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    if (args.length === 1) {
      ref = args[0], html = ref.html, element = ref.element, removeIndentation = ref.removeIndentation, replace = ref.replace;
    } else {
  ...
  replaceElementAsync: function() {
    var args, element, html, next, ref, removeIndentation, replace, result, tasks;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    if (args.length === 1) {
      ref = args[0], html = ref.html, element = ref.element, removeIndentation = ref.removeIndentation, replace = ref.replace, next = ref.next;
    } else {
